...
public class CookerPanelFragment80 extends CookerPanelFragment implements CircleProgress.OnCircleProgressListener , TrianProgressView.OnTrianProgressListener{
    ...
    private void switchTimerSetMode(int mode) {
        ...
        if (mode == WORK_MODE_SET_TIMER_HOUR) {
            tvTimerHour.setTextColor(Color.parseColor("#d84824"));  // 橙色
            ...
            tvTimerMinute.setTextColor(Color.parseColor("#d84824")); // 橙色
