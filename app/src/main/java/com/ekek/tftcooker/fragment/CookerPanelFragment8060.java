...
public class CookerPanelFragment8060 extends CookerPanelFragment implements CircleProgress.OnCircleProgressListener {
    ...
    CircularCookerView cookerViewUpRight;
    @BindView(R.id.cooker_view_down_right)
    CircularCookerView cookerViewDownRight;
    ...
    private boolean ClickTheHoodButton = false;
    ...
    protected int initLayout() {
        return R.layout.fragment_cooker_panel_fragment8060;
    }
    ...
    private void doLight() {   // 控制灯
        if (ClickTheHoodButton) {
            ClickTheHoodButton = false;
            switch (lightMode) {
                case LIGHT_MODE_OFF:
