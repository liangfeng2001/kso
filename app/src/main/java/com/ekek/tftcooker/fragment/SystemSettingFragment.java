...
public class SystemSettingFragment extends SystemSettingFragmentBase {
    ...
    public int initLayout() {
        return R.layout.setting_system;
    }
    @Override
    ...
    // Event handlers
    @OnClick({R.id.back, R.id.Time, R.id.Date, R.id.Language, R.id.Brightness, R.id.Volume,
            R.id.Reset, R.id.Power_usage, R.id.Connect, R.id.tv_title})
